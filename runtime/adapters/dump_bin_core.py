...
# python scripts/dump_bin.py dump_all --data_path  ~/Documents/quant/.data/cn_data_raw --qlib_dir ~/Documents/quant/.data/qlib_data --include_fields open,high,low,close,volume,amount,turn,tradestatus,isST  --file_suffix .csv
